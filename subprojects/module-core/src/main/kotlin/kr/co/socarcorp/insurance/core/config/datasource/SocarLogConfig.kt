...
import kr.co.socarcorp.insurance.core.config.datasource.SocarLogConfig.Companion.ENTITY_MANAGER_FACTORY_BEAN_NAME
import kr.co.socarcorp.insurance.core.config.datasource.SocarLogConfig.Companion.PACKAGE_NAME
import kr.co.socarcorp.insurance.core.config.datasource.SocarLogConfig.Companion.TRANSACTION_MANAGER_BEAN_NAME
...
class SocarLogConfig : CustomJpaConfig() {

    companion object {
        private const val UNIT_NAME = "socarlog"
